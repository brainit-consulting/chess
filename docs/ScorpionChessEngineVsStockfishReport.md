...
<!-- REPORT:START -->
Last updated: 2025-12-30T16:20:57.051Z (UTC) | 2025-12-30 11:20:57 ET
Series: Post-fix baseline series

Config: Scorpion hard @ 800ms | Stockfish movetime 400ms | swap=true | fenSuite=true | seed=7000
Commit: 0a70fd79e760f52601ee251ae4be0dcad664f0e7
Command: C:\Program Files\nodejs\node.exe H:\chess\scripts\bench\quickVsStockfish.ts --stockfish C:\Users\snake\Downloads\stockfish-windows-x86-64-avx2\stockfish\stockfish-windows-x86-64-avx2.exe --batch 10 --movetime 800 --stockfishMovetime 400 --mode hard --swap --fenSuite --seed 7000 --runId phase4_2-hard800-vs-sf400-b10 --reset
...
Movetime targets: BrainIT=800ms, Stockfish=400ms
Timeout tolerance: +25ms (bench-only stop-latency/jitter slack)
Next ladder rung: paused (Stockfish=400ms)
Output: H:\chess\scripts\bench\quick-results\run-phase4_2-hard800-vs-sf400-b10
...
Timed out moves: 4/371
Avg ms (non-timeout): 797.6, Avg ms (timeout): 912.3
Max ms (non-timeout): 916.4, Max ms (timeout): 916.0
...
--- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---
1 | 20 | 0 | 0 | 20 | 0.000 | n/a | 800/798.8 | 400/361.2 | B:4 SF:0 | 4/371 | 797.6/912.3 | 916.4/916.0 | 10.9 | 69
<!-- REPORT:END -->
