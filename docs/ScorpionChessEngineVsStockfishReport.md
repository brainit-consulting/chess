...
<!-- REPORT:START -->
Last updated: 2025-12-31T13:08:26.970Z (UTC) | 2025-12-31 08:08:26 ET
Series: Post-fix baseline series

Config: Scorpion hard @ 800ms | Stockfish movetime 500ms | swap=true | fenSuite=true | seed=7000
Commit: 6947c9006d452e73f2ac6904afdac19bfb57470e
Command: C:\Program Files\nodejs\node.exe H:\chess\scripts\bench\quickVsStockfish.ts --stockfish C:\Users\snake\Downloads\stockfish-windows-x86-64-avx2\stockfish\stockfish-windows-x86-64-avx2.exe --batch 25 --movetime 800 --stockfishMovetime 500 --mode hard --swap --fenSuite --seed 7000 --runId phase5_q1-hardLeafCheckMicroQ-hard800-vs-sf500-b25 --reset
...
Output: H:\chess\scripts\bench\quick-results\run-phase5_q1-hardLeafCheckMicroQ-hard800-vs-sf500-b25

Cumulative: 0-0-50 (50 games)
Score: 0.000
Elo delta: Outside estimation range (shutout).
Avg plies per game: 29.0
End reasons: mate=50, stalemate=0, repetition=0, 50-move=0, other=0
Timed out moves: 25/713
Avg ms (non-timeout): 806.5, Avg ms (timeout): 913.7
Max ms (non-timeout): 825.9, Max ms (timeout): 921.4
...
--- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---
1 | 50 | 0 | 0 | 50 | 0.000 | n/a | 800/810.2 | 500/416.6 | B:25 SF:0 | 25/713 | 806.5/913.7 | 825.9/921.4 | 5.2 | 299
<!-- REPORT:END -->
