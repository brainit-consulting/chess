...
<!-- REPORT:START -->
Last updated: 2025-12-30T21:26:43.455Z (UTC) | 2025-12-30 16:26:43 ET
Series: Post-fix baseline series

Config: Scorpion hard @ 800ms | Stockfish movetime 500ms | swap=true | fenSuite=true | seed=7000
Commit: b50cfe52d92bdff2c568ca299cf2bfef0cf04f60
Command: C:\Program Files\nodejs\node.exe H:\chess\scripts\bench\quickVsStockfish.ts --stockfish C:\Users\snake\Downloads\stockfish-windows-x86-64-avx2\stockfish\stockfish-windows-x86-64-avx2.exe --batch 25 --movetime 800 --stockfishMovetime 500 --mode hard --swap --fenSuite --seed 7000 --runId phase4_4_2b-hard800-vs-sf500-b25 --reset
...
Output: H:\chess\scripts\bench\quick-results\run-phase4_4_2b-hard800-vs-sf500-b25

Cumulative: 0-0-50 (50 games)
Score: 0.000
Elo delta: Outside estimation range (shutout).
Avg plies per game: 29.2
End reasons: mate=50, stalemate=0, repetition=0, 50-move=0, other=0
Timed out moves: 23/718
Avg ms (non-timeout): 802.8, Avg ms (timeout): 914.7
Max ms (non-timeout): 910.6, Max ms (timeout): 923.8
...
--- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---
1 | 50 | 0 | 0 | 50 | 0.000 | n/a | 800/806.4 | 500/427.3 | B:23 SF:0 | 23/718 | 802.8/914.7 | 910.6/923.8 | 4.4 | 130
<!-- REPORT:END -->
