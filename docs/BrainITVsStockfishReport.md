...
<!-- REPORT:START -->
Last updated: 2025-12-27T23:41:15.805Z
...
Cumulative: 0-0-48 (48 games)
Score: 0.000
Elo delta: Outside estimation range (shutout).
Avg plies per game: 33.8
End reasons: mate=42, stalemate=0, repetition=0, 50-move=0, other=0
Timed out moves: 569/573
Avg ms (non-timeout): 231.6, Avg ms (timeout): 290.6
